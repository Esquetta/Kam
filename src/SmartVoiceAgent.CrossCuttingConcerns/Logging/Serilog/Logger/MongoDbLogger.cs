...
public class MongoDbLogger : LoggerServiceBase
{
    ...
    {
        const string configurationSection = "MongoDbConfiguration";
        ...
        Logger = new LoggerConfiguration().WriteTo
            .MongoDBBson(cfg =>
            {
                ...
                IMongoDatabase? mongoDbInstance = client.GetDatabase(logConfiguration.Database);
                cfg.SetMongoDatabase(mongoDbInstance);
                cfg.SetCollectionName(logConfiguration.Collection);
            })
            .CreateLogger();
    }
}
